...
The three drivers on the machine root, what each carries, and homing: where each axis meets its switch and its hard stop, and how long getting there takes at the firmware's feedrates.
